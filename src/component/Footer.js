        ...
        <div className="container">
            ...
            <div className="d-flex flex-wrap pb-3 gap-3 justify-content-between align-items-center">
                <div className="d-flex  align-items-center ps-4 ps-lg-1">
                    ...
                    <button className=' text-light   text-center border border-light border-1 mx-2 rounded rounded-circle d-flex justify-content-center align-items-center' style={{backgroundColor:"transparent",width:'50px',height:'50px' ,fontSize:'30px'}}><FaInstagram/> </button>
                    <button className=' text-light   text-center border border-light border-1 mx-2 rounded rounded-circle d-flex justify-content-center align-items-center' style={{backgroundColor:"transparent",width:'50px',height:'50px' ,fontSize:'30px'}}><FaYoutube/> </button>
                    <button className=' text-light   text-center border border-light border-1 mx-2 rounded rounded-circle d-flex justify-content-center align-items-center' style={{backgroundColor:"transparent",width:'50px',height:'50px' ,fontSize:'30px'}}><RiPinterestLine/> </button>
                    <button className=' text-light   text-center border border-light border-1 mx-2 rounded rounded-circle d-flex justify-content-center align-items-center' style={{backgroundColor:"transparent",width:'50px',height:'50px' ,fontSize:'30px'}}><CiTwitter/> </button>
                </div>
                <div className="d-flex align-items-center ps-4 ps-lg-1">
                    <h5 className='fw-bold text-light py-2 ' >Mobile App</h5>
                    <button className=' text-light   text-center border border-light border-1 mx-2 rounded rounded-circle d-flex justify-content-center align-items-center' style={{backgroundColor:"transparent",width:'50px',height:'50px' ,fontSize:'30px'}}><IoLogoAndroid /> </button>
                    <button className=' text-light   text-center border border-light border-1 mx-2 rounded rounded-circle d-flex justify-content-center align-items-center' style={{backgroundColor:"transparent",width:'50px',height:'50px' ,fontSize:'30px'}}><FaApple/> </button>
